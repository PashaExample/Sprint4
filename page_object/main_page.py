...
from page_object.locators_main import MainPageLocators


class MainPage(BasePage):
    @allure.step("We agree to cookies")
    def accept_cookie(self):
        cookie = self.find_element(MainPageLocators.accept_cookies)
        cookie.click()
    @allure.step("Click on a question from the 'Important Questions' section")
    ...
    @allure.step("Click the 'Order' button")
